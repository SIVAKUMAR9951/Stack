...
class Documents_Category extends StatefulWidget {
  const Documents_Category({Key? key}) : super(key: key);

  @override
  _Documents_Category createState() => _Documents_Category();
}

class _Documents_Category extends StateMVC<Documents_Category> {
            ...
            children: [
              Card(
                ...
                child: Container(
                  ...
                  child: Text("Most Trending Documents",
                      style: TextStyle(
