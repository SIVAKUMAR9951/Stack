...
class _Book_Category extends StateMVC<Book_Category> {
  ...
  Book_Controler _newsController = Book_Controler();
  ModelAllBook? modelAllBook;

  _Book_Category() :  super(Book_Controler());
      ...
      body: SingleChildScrollView(
        ...
        children: [
          ...
          Container(
            margin: EdgeInsets.only(left: 20, top: 10, right: 20, bottom: 10),
            alignment: Alignment.centerLeft,
            child: Text("Last Week Reading Books", style: textStyleBold()),
          ),
          Container(
            child: SingleChildScrollView(
                child: Container(
          ...
          Container(
            margin: EdgeInsets.only(left: 20, top: 10, right: 20, bottom: 10),
            alignment: Alignment.centerLeft,
            child: Text("Saved Books", style: textStyleBold()),
          ),
          Container(
            child: SingleChildScrollView(
                child: Container(
