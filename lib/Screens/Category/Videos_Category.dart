...
class Video_Category extends StatefulWidget {
  const Video_Category({Key? key}) : super(key: key);

  @override
  _Video_Category createState() => _Video_Category();
}

class _Video_Category extends StateMVC<Video_Category> {
  ...
  Future<List<dynamic>> readingBooks() async {
    ...
    var result = await http
        .post(Uri.parse("http://stack.kriyaninfotech.com/api/relatedbooks/25"),body: data,);
    print(result.body);
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text("Most Trending Video Books", style: textStyleBold()),
              ),
              Container(
              ...
              Container(
                margin: EdgeInsets.only(left: 20, top: 10, right: 20, bottom: 10),
                alignment: Alignment.centerLeft,
                child: Text("Last Week Watching Video Books", style: textStyleBold()),
              ),
              Container(
                child: SingleChildScrollView(
                    child: Container(
              ...
              Container(
                margin: EdgeInsets.only(left: 20, top: 10, right: 20, bottom: 10),
                alignment: Alignment.centerLeft,
                child: Text("Saved Video Books", style: textStyleBold()),
              ),
              Container(
                child: SingleChildScrollView(
                    child: Container(
